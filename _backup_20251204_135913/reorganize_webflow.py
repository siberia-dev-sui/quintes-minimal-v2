    ...
    for img in soup.find_all('img'):
        ...
        if srcset:
            ...
            for part in srcset.split(','):
                ...
                # The URL is usually the first part, but there might be leading spaces
                # split(' ') might give empty strings if multiple spaces.
                # Better: part.strip().split() -> splits by any whitespace
                parts = part.strip().split()
